...
INSERT INTO `resc`(`id`,`res_type`,`name`,`res_string`,`descn`) VALUES ('2', null, 'URL', '/api/**', 'restful api接口');   
INSERT INTO `resc`(`id`,`res_type`,`name`,`res_string`,`descn`) VALUES ('3', null, 'URL', '/views/index.xhtml', '测试页面'); 
